...
const CALCS = [
  ...
  // ── Trabalhistas ──────────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'Calculadora de Rescisão Trabalhista Online Grátis 2025',
    ...
    desc: 'Calcule todas as verbas rescisórias: saldo de salário, 13º proporcional, férias + 1/3, aviso prévio indenizado e multa do FGTS (40% ou 20%). Funciona para demissão sem justa causa, pedido de demissão, acordo mútuo e justa causa. Tabelas INSS/IR 2025.',
    icone: '📋',
  ...
  },
  {
    ...
    metaTitle: 'Calculadora de Férias CLT Online Grátis 2025 — Com 1/3 e INSS',
    metaDesc: 'Calcule o valor das suas férias com 1/3 constitucional, abono pecuniário, INSS e IR. Férias proporcionais ou período completo. Grátis 2025.',
    ...
    icone: '🏖️',
    instrucoes: 'Informe o salário, os meses trabalhados no período aquisitivo e os dias de férias (conforme número de faltas). Marque a opção de abono se quiser vender 10 dias. A calculadora aplica automaticamente as tabelas de INSS e IR 2025.',
  },
  {
    slug: 'calculadora-online-de-13-salario',
    titulo: 'Calculadora Online de 13º Salário',
    metaTitle: 'Calculadora de 13º Salário Online Grátis 2025 — Com INSS e IR',
  ...
  },
  {
    ...
    titulo: 'Calculadora Online de INSS 2025',
    ...
    desc: 'Calcule a contribuição previdenciária para empregado CLT, doméstico, autônomo (20%), contribuinte individual prestador de serviço a empresa (11%) e MEI (5% fixo). Tabela progressiva INSS 2025 com detalhamento por faixa de incidência e código de recolhimento GPS.',
    icone: '🏛️',
    instrucoes: 'Selecione o tipo de contribuinte e informe o salário/remuneração. Para MEI, o valor é fixo (5% do salário mínimo). A tabela completa INSS 2025 está disponível no final da calculadora.',
  },
  {
    slug: 'calculadora-online-de-fgts',
    titulo: 'Calculadora Online de FGTS',
    metaTitle: 'Calculadora de FGTS Online Grátis 2025 — Saldo, Multa e Saque-Aniversário',
