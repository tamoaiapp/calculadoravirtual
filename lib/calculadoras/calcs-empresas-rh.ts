...
export const CALCS_EMPRESAS_RH: CalcConfig[] = [
  ...
  { slug: 'calculadora-indice-absenteismo', titulo: 'Índice de Absenteísmo', desc: 'Calcule o absenteísmo e seu impacto financeiro.', cat: 'Empresas e RH', icon: '📊', campos: [{ k: 'diasPerdidos', l: 'Dias perdidos no mês', t: 'num', p: '15', min: 0 }, { k: 'totalFuncionarios', l: 'Total de funcionários', t: 'num', p: '20', min: 1 }, { k: 'diasUteis', l: 'Dias úteis no mês', t: 'num', p: '22', min: 1 }, { k: 'salarioMedio', l: 'Salário médio (R$)', t: 'num', p: '3000', min: 0 }], fn: (v) => { const indice = (v.diasPerdidos / (v.totalFuncionarios * v.diasUteis)) * 100; const custo = v.diasPerdidos * (v.salarioMedio / v.diasUteis); return { principal: { valor: indice, label: 'Índice de absenteísmo (%)', fmt: 'pct' }, detalhes: [{ l: 'Custo do absenteísmo', v: custo, fmt: 'brl' }, { l: 'Referência: acima de 3% é crítico', v: indice > 3 ? 'Crítico' : 'Aceitável', fmt: 'txt' }] } }, dis: DIS_RH },
